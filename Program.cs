...
public class Program
{
    static void Main()
    {
        ...
        // Console.WriteLine(ex.Output[0].Count(p => p == ' '));
        // Console.WriteLine (ex.Output.Length);

        Blue_2 ex1 = new Blue_2(ex.Input, "Ос");
        ex1.Review();
        // Console.WriteLine(ex1.ToString());

        Blue_2 ex5 = new Blue_2("Фьорды – это ущелья, формирующиеся ледниками и заполняющиеся морской водой. Название происходит от древнескандинавского слова \"fjǫrðr\". Эти глубокие заливы, окруженные высокими горами, представляют захватывающие виды и природную красоту. Они популярны среди туристов и известны под разными названиями: в Норвегии – \"фьорды\", в Шотландии – \"фьордс\", в Исландии – \"фьордар\". Фьорды играют важную роль в культуре и туризме региона, продолжая вдохновлять людей со всего мира.", "фь");
        string[] a = ex5.Input.Split(" ");
        ...
        Blue_3 ex7 = new Blue_3(ex3.Input);
        ex7.Review();
        // Console.WriteLine(ex7.ToString().Length);
    }
}